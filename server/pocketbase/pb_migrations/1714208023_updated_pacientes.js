...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("5z6qjus9")

  // remove
  collection.schema.removeField("faysdcxi")
  ...
  // remove
  collection.schema.removeField("rb1mhgnl")
  ...
  // remove
  collection.schema.removeField("htdmgpa9")
